<?php
  ...
  class User {
    ...
    public string $pfpicture;
    public float $rating;
    public int $phoneNumber;
    public int $isAdmin;

    public function __construct(int $id, string $name, string $username, string $email, string $password, string $gender, string $pfpicture, float $rating, int $phoneNumber, int $isAdmin) { 
      $this->id = $id;
      $this->name = $name;
