<?php function drawListItem() {
    ...
    <div class="list-item">
        ...
        <h2>Add Item</h2>
        <form id="list-item-form" action="../actions/action_list_item.php" method="post">
            <div>
                <label for="title">Title</label>
                <input type="text" name="title" class="input-list-row title-input" value="<?php echo $item['title']; ?>" required>
            </div>
            <div>
                <label for="description">Description</label>
                <input type="text" name="description" class="input-list-row description-input" value="<?php echo $item['description']; ?>">
            </div>
            <div>
                <label for="color">Color</label>
                <select name="color" class="input-list-row color-input" required>
                    <?php
                    $colors = getColors();
            ...
            <div>
                ...
                <select name="type_item" class="input-list-row type_item-input" required>
                    <?php
                    $types = getTypeItems();
            ...
            <div>
                ...
                <input type="text" name="picture" class="input-list-row picture-input" value="<?php echo $item['picture']; ?>" required>
            </div>
            <div>
                <label for="price">Price</label>
                <input type="text" name="price" class="input-list-row price-input" value="<?php echo $item['price']; ?>" required>
            </div>
            <div>
                <label for="condition">Condition</label>
                <select name="condition" class="input-list-row condition-input" required>
                    <?php
            ...
            <div>
                ...
                <select name="idBrand" class="input-list-row idBrand-input" required>
                    <?php
                    $brands = getBrands();
            ...
            <div>
                ...
                <select name="idSize" class="input-list-row idSize-input" required>
                    <?php
                    $sizes = getSizes();
